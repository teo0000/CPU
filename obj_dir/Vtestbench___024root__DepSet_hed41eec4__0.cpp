...
bool Vtestbench___024root___eval_phase__ico(Vtestbench___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtestbench___024root___eval_phase__ico\n"); );
    // Init
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__1(Vtestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->testbench__DOT__cpu__DOT__pc = ((IData)(vlSelf->reset)
                                             ? 0U : vlSelf->testbench__DOT__cpu__DOT____Vcellinp__PC__next_pc);
...
void Vtestbench___024root___eval(Vtestbench___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        ...
        __VicoContinue = 0U;
        if (Vtestbench___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
